...
import { buildDrawSvg, buildIconSvg, buildImageStrokeSvg, buildShapeSvg, iconStrokePadPx, imageStrokePadPx, innerShadowFilter, shapeStrokePadPx } from "@/lib/export/elementSvg";
  ...
  const svgPad =
    el.type === "shape"
      ...
      : el.type === "image" && el.stroke?.enabled && (el.stroke.width || 0) > 0
        ...
        : el.type === "icon" && el.stroke?.enabled && (el.stroke.width || 0) > 0
          ? iconStrokePadPx(el, width, height)
          : { px: 0, py: 0 };
