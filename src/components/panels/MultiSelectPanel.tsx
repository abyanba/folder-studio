 ...
 * selected (legacy L1974-2004). Shared opacity/rotation (displaying the
 * average), plus same-type extras — text size/weight/align, icon uniform
 * size, shape fill. Unlike the legacy `mUp` (raw setState, not undoable),
 * every edit goes through `updateElements` → one undo entry.
 */
...
export function MultiSelectPanel() {
  ...
  return (
    <div>
      <PanelHeader title={`${sel.length} selected`} />
