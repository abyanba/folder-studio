...
export const ICON_NAMES: Record<string, string[]> = {
  ...
  "Dev & Files": ["code", "terminal", "brackets-curly", "brackets-round", "brackets-square", "git-branch", "git-commit", "git-merge", "git-pull-request", "database", "cloud", "cloud-arrow-up", "cloud-arrow-down", "cloud-check", "hard-drive", "cpu", "wifi", "globe", "monitor", "laptop", "device-mobile", "keyboard", "bug", "hash", "plug", "file-code", "file-zip", "package", "stack", "layers"],
  UI: ["squares-four", "circle", "triangle", "diamond-four", "hexagon", "octagon", "shield", "sliders", "sliders-horizontal", "list", "list-bullets", "list-checks", "list-numbers", "table", "layout", "sidebar", "columns", "rows", "grid-four", "dots-nine", "app-window", "browsers", "faders", "funnel", "tag", "frame", "selection", "star", "check-square", "minus-square"],
  Commerce: ["shopping-cart", "shopping-bag", "tag", "price-tag", "credit-card", "wallet", "bank", "currency-dollar", "currency-euro", "currency-bitcoin", "coin", "coins", "chart-bar", "chart-line", "chart-pie", "chart-donut", "trend-up", "trend-down", "receipt", "gift", "handshake", "percent", "seal-check", "buildings", "briefcase", "barcode", "qr-code"],
  Nature: ["sun", "sun-dim", "moon", "moon-stars", "cloud", "cloud-rain", "cloud-snow", "cloud-sun", "cloud-lightning", "snowflake", "leaf", "flower", "flower-tulip", "tree", "tree-evergreen", "drop", "fire", "lightning", "mountains", "planet", "compass", "map", "map-pin", "anchor", "waves", "paw-print", "sparkle", "thermometer", "wind", "umbrella", "feather"],
};
